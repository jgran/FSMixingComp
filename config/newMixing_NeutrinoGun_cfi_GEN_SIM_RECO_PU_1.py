...
# with command line options: SingleElectronFlatPt5To100_cfi -s GEN,SIM,RECO --fast --pileup mix_2012_Summer_inTimeOnly --conditions auto:startup_GRun --beamspot Realistic8TeVCollision --eventcontent=FEVTDEBUGHLT --datatier GEN-SIM-DIGI-RECO -n 1000 --no_exec
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(5000) # XXX 5k
)
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('newMixing_NeutrinoGun_GEN_SIM_RECO_PU_1.root'), # XXX jobnum
